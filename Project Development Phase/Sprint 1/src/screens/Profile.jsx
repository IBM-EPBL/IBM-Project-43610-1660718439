...
import { AiOutlineClose } from react-iconsai;
import { BsLinkedin } from react-iconsbs;
import { GoMarkGithub } from react-iconsgo;
import { MdDeleteForever } from react-iconsmd;
import { RiEdit2Fill } from react-iconsri;
import { TfiTwitterAlt } from react-iconstfi;
import { VscAdd } from react-iconsvsc;
        ...
        div className=border-2 border-blue-100 w-full h-fit rounded-xl p-5 flex flex-col gap-3
          div className=flex justify-between w-full min-h-[25vh]
            div className=flex flex-col justify-between
              h1 className=mdtext-2xl  text-xl font-medium flex items-center gap-4
                Your Profile{ }
                button
                  {isEditingEnabled  (
                    AiOutlineClose
              ...
              div className=flex flex-col gap-3
                {isEditingEnabled  (
                    ...
                    h2 className=mdtext-2xl xltext-2xl smtext-xl
                      {user.name}
                    h2
                    p className=mdtext-xl smtext-md text-gray-700
                      {user.email}
                    p
            ...
            div className=flex flex-col justify-end w-fit gap-4
              img
                src=avatar.webp
                alt=profile
                className=mdw-36 w-20 rounded-md object-contain
              
            div
          div
          div className=divider my-2div
          div className=flex flex-col
            div className=flex justify-between gap-2 flex-col
              h4 className=text-xlSkillsh4
              form
                ...
                button
                  className=hoverrotate-90 transition-all
            ...
            div className=divider my-2div
            div className=flex justify-between gap-2 flex-col
              h4 className=text-xlResumePortfolioh4
              div className=flex gap-5
                ...
                button className=btn btn-primary btn-smupdatebutton
              div
            div
            div className=divider my-2div
            div className=flex gap-2 flex-col
              h3 className=text-xlSocialsh3
